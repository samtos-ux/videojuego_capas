...
public class AplicacionCliente {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("CLIENTE: Introduzca la operaci�n a realizar:");
			...
			case "1":
				...
				numero1 = sc.next();// aqui se queda parada la app hasta que intro datos
			...
			case "5":
				...
				break;
			default:
				System.out.println("No has elegido ninguna opcion v�lida");
				break;
			}
